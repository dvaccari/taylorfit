...
module.exports.buildModel = (data, degree, indepCol) => {
  ...
  return new Model(data.subset(inputColumns), data.subset(outputColumn), degree);
};


load('./prototype/bla.data', true, (data) => {
  console.time('compute');
  var model = module.exports.buildModel(data, 3, 2);
